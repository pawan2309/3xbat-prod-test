...
async function getGames(req, res, currentUser) {
    try {
        ...
        const [matches, total] = await Promise.all([
            ...
            prisma_1.prisma.match.count({ where })
        ]);
...
async function createGame(req, res, currentUser) {
    try {
        ...
        const { name, description, type, minBet = 0, maxBet = 1000, odds = 1.0, startTime, endTime } = req.body;
