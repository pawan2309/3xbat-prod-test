...
export declare const updateUserLimit: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const updateUserLimits: (req: Request, res: Response) => Promise<void>;
export declare const transferLimit: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
...
export declare const getUserLedger: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const createManualLedger: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
