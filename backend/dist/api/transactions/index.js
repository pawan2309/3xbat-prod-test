...
async function getTransactions(req, res, currentUser) {
    try {
...
async function createTransaction(req, res, currentUser) {
    try {
        const { type, amount, description, reference, userId } = req.body;
