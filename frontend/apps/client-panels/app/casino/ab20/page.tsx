    ...
    const fetchData = async () => {
      try {
        const [dataResponse, resultsResponse] = await Promise.all([
          fetch(`${getApiBaseUrl()}/api/casino/data/ab20`),
          fetch(`${getApiBaseUrl()}/api/casino/results/ab20`)
        ]);
        ...
        console.error('Error fetching AB20 data:', error);
      }
    };
          ...
          <div className="bg-black">
            <div className="flex">
              <iframe 
                ...
                allowFullScreen 
                src="https://casinostream.trovetown.co/route/?id=3036"
              ></iframe>
            </div>
