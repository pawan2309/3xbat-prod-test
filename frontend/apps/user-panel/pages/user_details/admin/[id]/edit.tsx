...
const EditAdmin = () => {
  ...
  useEffect(() => {
    if (!id) return;
    console.log('Loading user with ID:', id); // Debug log
    setLoading(true);
    ...
    try {
      const res = await fetch(`/api/users/role-based`, {
        ...
        body: JSON.stringify({
          ...
          matchCommission: form.commissionType === 'BetByBet' ? form.matchCommission : 0,
      ...
      <section className="content-header pb-2">
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-6"><h1 className="text-capitalize">Edit Admin</h1></div>
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                <li className="breadcrumb-item"><a href="/">Home</a></li>
                <li className="breadcrumb-item active text-capitalize">Edit Admin</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit}>
                  ...
                  <div className="card-body">
                    ...
                    {form.casinoStatus && (
                      <>
                        <div className="form-group row mb-0">
                          <div className="form-group col-md-6">
                            <label>Admin Casino Share</label>
            ...
            <div className="row mx-0 ">
              <div className="col-12 subowner-cancel-create mb-4 px-0">
                <button type="button" className="btn btn-secondary" onClick={() => router.push('/user_details/admin')}>Cancel</button>
