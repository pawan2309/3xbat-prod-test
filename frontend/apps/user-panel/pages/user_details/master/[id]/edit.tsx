    ...
    const fetchData = async () => {
      try {
        ...
        if (userData.success) {
          ...
          console.log('UserCommissionShare:', userData.user.userCommissionShare);
      ...
      <section className="content-header pb-2">
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-6"><h1 className="text-capitalize">Edit Master</h1></div>
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                <li className="breadcrumb-item"><a href="/">Home</a></li>
                <li className="breadcrumb-item active text-capitalize">Edit Master</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit}>
                  ...
                  <div className="card-body">
                    ...
                    {form.casinoStatus && (
                      <>
                        <div className="form-group row mb-0">
                          <div className="form-group col-md-6">
                            <label>Master Casino Share</label>
            ...
            <div className="row mx-0 ">
              <div className="col-12 subowner-cancel-create mb-4 px-0">
                <button type="button" className="btn btn-secondary" onClick={() => router.push('/user_details/master')}>Cancel</button>
