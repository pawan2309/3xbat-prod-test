      ...
      <section className="content-header pb-2">
        <div className="container-fluid">
          <div className="row mb-2">
            <div className="col-sm-6"><h1 className="text-capitalize">Edit Super Admin</h1></div>
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                <li className="breadcrumb-item"><a href="/">Home</a></li>
                <li className="breadcrumb-item active text-capitalize">Edit Super Admin</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="col-md-6">
                <div className="card tbaleCard card-primary">
                  ...
                  <div className="card-body">
                    ...
                    <div className="form-group"><label>Flat Share</label><select name="flatShare" className="form-control shadow-none" value={form.flatShare} onChange={handleChange}><option value="No">No</option><option value="Yes">Yes</option></select></div>
                  </div>
                </div>
              </div>
              <div className="col-md-6">
                  ...
                  <div className="card-body">
                    ...
                    {form.casinoStatus && (
                      <>
                        <div className="form-group row mb-0">
                          <div className="form-group col-md-6">
                            <label>Super Admin Casino Share</label>
            ...
            <div className="row mx-0 ">
              <div className="col-12 subowner-cancel-create mb-4 px-0">
                <button type="button" className="btn btn-secondary" onClick={() => router.push('/user_details/super_admin')}>Cancel</button>
